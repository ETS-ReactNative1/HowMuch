...
const ServicesDetail = ({ navigation }) => {
  ...
  return (
    <>
      ...
      <Header arrow={true} title="Service Detail" notification={true} />
      <ScrollView>
        ...
        <View style={styles.details}>
          <View style={styles.containt}>
            <Image style={styles.mainImg} source={Images.Pictures.work} />
            <View>
              <Text
                style={{
                  color: '#0888FF',
        ...
        <View>
          <View style={styles.topViewlist}>
            <Text style={styles.txtone}>Related Services</Text>
            <TouchableOpacity>
