    ...
    return (
      <>
        ...
        <View style={styles.container}>
          ...
          return (
            <View >
                <Image style={{width:115,height:115,marginHorizontal:6,resizeMode:"contain",marginVertical:6}} source={item.image}/>
            </View>
          )
        })}
        <View  style={styles.dotted}>
                <Text style={{fontSize:34,fontWeight:"bold",color:"#CAD2DB"}}>+</Text>
            </View>
            </View>
